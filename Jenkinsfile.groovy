...
@Library('select_tags@tags/v1.1.1') _
//Comment
pipeline {
  agent {
    label 'jenkins-slave'
...
parameters {
        choice(name: 'TAG_VERSION', choices: getGitHubTags("https://github.com/fulwin2/nmp/tags"), description: 'Choose the Git tag version to build')
}
